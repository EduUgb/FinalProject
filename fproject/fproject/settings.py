...
SECRET_KEY = 'django-insecure-e+llt(7l2-%66!s#dqo#1f2m1%4p-9exini2wojo=&kkk^1d15'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Esta es la ubicación donde tus archivos estáticos se guardarán
]
